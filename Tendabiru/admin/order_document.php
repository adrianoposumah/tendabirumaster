                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="col-md-1 text-center"><?php echo $order->prod_name; ?></td>
                                    <td class="col-md-1 text-center">$<?php echo $order->prod_price; ?></td>
                                    <td class="col-md-1 text-center"><?php echo $order->prod_odr_qty; ?></td>
                                    <td class="col-md-1 text-center"><?php echo date('d/M/Y g:i', strtotime($order->created_at)); ?></td>
                                </tr>
                            <?php } ?>
                        </tbody>
                    </table>
