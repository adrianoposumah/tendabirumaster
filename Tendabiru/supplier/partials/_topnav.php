...
$ret = "SELECT * FROM  suppliers  WHERE supplier_id = '$supplier_id'";
                    ...
                    <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="media align-items-center">
                            <span>
                                ...
                                echo "<img src='assets/img/$supplier->supplier_img' height='60' width='60 class='img-thumbnail' style='border-radius: 50%;'>";
                                } else {
                            ...
                            <div class="media-body ml-2 d-none d-lg-block">
                                <span class="mb-0 text-sm  font-weight-bold"><?php echo $supplier->supplier_name; ?></span>
                            </div>
                        </div>
                    </a>
