...
$ret = "SELECT * FROM  staffs  WHERE staff_id = ?";
...
if ($res && $staff = $res->fetch_object()) {
    ...
    if (isset($_POST['AmbilStok'])) {
        ...
        if (empty($_POST["prod_qty"])) {
            ...
            $daily_staff = $staff->staff_name; // Use the staff name from the session
    ...
    // Handle the case where staff details are not fetched
    $err = "Error fetching staff details";
}
                        ...
                        <div class="card shadow">
                            ...
                            <div class="card-body">
                                <form method="POST" enctype="multipart/form-data">
                                  ...
                                  <input type="hidden" name="daily_staff" value="<?php echo $staff-> staff_name; ?>" class="form-control">
                                    <div class="form-row">
                                        <div class="col-md-6">
